...
<section id="content" style="position: absolute;top:50;left:110px; ">
	<form name="frm" action="<%=request.getContextPath()%>/Category">
			
	<font color="#00CED1" size="4"><b><h1>ADD CATEGORY DETAILS</h1></b></font>
	<table style="width: 650px;   text-align: center;">
		...
		<tr align="center">
			...
			<td><font color="#00CED1" size="4"><b>
					<input type="text" name="cat" id="ids" class="easyui-validatebox"   onKeyPress="return ValidateAlpha(event);"  required="required" autofocus required  title="Please,Enter The Company Name."/>
			</b></font></td>
...
%>
    		...
    		alert(' sorry this Category already exist');
