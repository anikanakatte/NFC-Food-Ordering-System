...
<section id="content">
<form name="myForm" action="<%=request.getContextPath()%>/SupportUsers">	
<div style="position: relative;top: 50px;left: 50px;">
<font color="#00CED1" size="3"><b> <h1>SUPPORT USERS </h1></b></font>
</div>
...
<table id="results" class="tab" align="center" cellspacing="10">
	<tr>
		...
		<th><font color="#00CED1" size="4"><b>Name</b></font></th>
		<th><font color="#00CED1" size="4"><b>Age</b></font></th>
		<th><font color="#00CED1" size="4"><b>Sex</b></font></th>
		<th><font color="#00CED1" size="4"><b>Role</b></font></th>
		<th><font color="#00CED1" size="4"><b>Phone</b></font></th>
		<th><font color="#00CED1" size="4"><b>Email</b></font></th>
...
%>
    		...
    		alert('Support User Details Added Successfully.....!');
...
%>
    		...
    		alert('Support Users Details Deleted Successfully.....!');
...
%>
    		...
    		alert(' Support Usesr Details Updated Successfully....!');
