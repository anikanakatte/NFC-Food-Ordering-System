...
<section id="content">
<form name="myForm" action="<%=request.getContextPath()%>/Items">	
<div style="position: relative;top: 50px;left: 50px;">
<font color="#00CED1" size="3"><b> <h1>ITEM DETAILS </h1></b></font>
</div>
...
<table id="results" class="tab" align="center" cellspacing="10">
	<tr>
		...
		<th><font color="#00CED1" size="4"><b>Item name</b></font></th>
		<th><font color="#00CED1" size="4"><b>Price</b></font></th>
