...
<%!
	ResultSet rs = null;
	String farebus="";
	String item="",price="",sex="",role="",phone="",email="";
	int id=0;
	int cid=0;
...
<section id="content" style="position: absolute;top:35;left:190px;">
	...
	<font color="#00CED1" size="4"><b><h1>Update Item Details</h1></b></font>
	<table style="width: 500px;text-align: center;">
		...
		<tr align="center">
			...
			<td>
					<input type="text" name="cid" value="<%=cid%>"  class="easyui-validatebox" required="required" autofocus required   readonly="readonly"/>
			</td>
			...
			<td>
					<input type="text"  id="tp" name="item" value="<%=item%>"  class="easyui-validatebox" required="required" autofocus required  />
			</td>
		...
		<tr align="center">
			...
			<td>
					<input type="text" name="price" value="<%=price%>" class="easyui-validatebox"  required="required" />
			</td>
